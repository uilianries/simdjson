...
class BuilderSettings(object):
    ...
    @property
    def username(self):
        """ Set simdjson as package's owner
        """
        return os.getenv("CONAN_USERNAME", "lemire")

    @property
    def upload(self):
        """ Set simdjson repository to be used on upload.
        ...
        if self.is_tag:
            return "https://api.bintray.com/conan/lemire/conan"
    ...
    def reference(self):
        ...
        """
        return os.getenv("CONAN_REFERENCE", "simdjson/{}".format(self.version))
...
if __name__ == "__main__":
    ...
    if os.getenv("CONAN_CLANG_VERSIONS", False) == "7.0":
        builder.add({}, {"simdjson:header_only" : True}, {}, {})
    builder.run()
